			...
			<div className='aboutMain'>
				<ul className='aboutList'>
					...
					<li className='under'><div className='dropdown'>
							...
							<div className='dropdown-content'>
								<p>
									...
									This website is a collection of resources for addressing controversies surrounding science
									designed for secondary school students and public audiences
									differentiated for two ability levelsfor supporting class discussions, cross-curricular events and for public engagement
					...
					<li className='under'><div className='dropdown'>
							...
							<div className='dropdown-content'>
								<p>
									The Biochemical Society is a UK based  Learned Society for the advancement of biochemistry. The major charitable objective of the Society is to promote biochemistry in a variety of educational contexts. We seek to inspire the next generation of young bioscientists and promote a better understanding of the key biological challenges faced by citizens of the future. The Society also fulfills its charitable mission through scientific conferences, publications, grant schemes and career events, many of which are resourced by our membership.Other online resources from the Biochemical Society include:The Understanding Biochemistry issues of Essays in Biochemistry provide up to date overviews of key concepts in biochemistry. For more information about the Society's activities for schools, please see:www.biochemistry.org/education/ SciberBrain was originally sponsored by the Monsanto Fund http://www.monsantofund.org/
								</p>
							</div>
						</div></li>
					<li className='under'><div className='dropdown'>
